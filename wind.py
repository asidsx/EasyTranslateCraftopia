...
class Application(tk.Frame):
    ...
    def load_eng(self):
        ...
        language_regex = re.compile(r'\[0\]1 string Languages = "((?:<.*?>|\s|[^"])+)"')
    ...
    def load_jp(self):
        ...
        term_regex = re.compile(r'Term = "(.+?)"')
        language_regex = re.compile(r'\[1\]1 string Languages = "((?:<.*?>|\s|[^"])+)"')
    ...
    def load_cn(self):
        ...
        term_regex = re.compile(r'Term = "(.+?)"')
        language_regex = re.compile(r'\[2\]1 string Languages = "((?:<.*?>|\s|[^"])+)"')
    ...
    def load_TW(self):
        ...
        term_regex = re.compile(r'Term = "(.+?)"')
        language_regex = re.compile(r'\[3\]1 string Languages = "((?:<.*?>|\s|[^"])+)"')
